...
def combine_models(infer_path: str, infer_rotate_path: str, prefill_path: str, output_path: str) -> bool:
    """Combine infer, infer_rotate, and prefill models into multi-function model.
    ...
    Args:
        ...
        infer_rotate_path: Path to infer_rotate model (rotation mode, for pos >= 512)
                          If None, only infer and prefill are combined.
    ...
    try:
        ...
        print("\nUsage:")
        print("  - prefill: Use for initial context (fills positions 0 to N-1)")
        print("  - infer: Use for positions < sliding_window (512)")
        print("  - infer_rotate: Use for positions >= sliding_window (512)")
        return True
...
if __name__ == "__main__":
    ...
    success = combine_models(infer_path, infer_rotate_path, prefill_path, output_path)
